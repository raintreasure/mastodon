...
export const ACCOUNT_SUBSCRIBE_REQEUST = 'ACCOUNT_SUBSCRIBE_REQEUST';
...
export const ACCOUNT_UNSUBSCRIBE_REQEUST = 'ACCOUNT_UNSUBSCRIBE_REQEUST';
...
export function subscribeAccount(url, id) {
  return (dispatch, getState) => {
...
export function unsubscribeAccount(url, id) {
  return (dispatch, getState) => {
...
export const subscribeAccountRequest = id => ({
  type: ACCOUNT_SUBSCRIBE_REQEUST,
  id,
});
export const subscribeAccountSuccess = relationship => ({
  relationship,
  type: ACCOUNT_SUBSCRIBE_SUCCESS,
});
export const subscribeAccountFail = id => ({
  type: ACCOUNT_SUBSCRIBE_FAIL,
  id,
});

export const unsubscribeAccountRequest = id => ({
  type: ACCOUNT_UNSUBSCRIBE_REQEUST,
  id,
});
export const unsubscribeAccountSuccess = relationship => ({

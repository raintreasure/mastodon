...
class Scheduler::IpCleanupScheduler
  ...
  IP_RETENTION_PERIOD = ENV.fetch('IP_RETENTION_PERIOD', 1.minute).to_i.seconds.freeze
  SESSION_RETENTION_PERIOD = ENV.fetch('SESSION_RETENTION_PERIOD', 1.minute).to_i.seconds.freeze
